...
Repozytorium zawiera kody wykorzystane w części symulacyjnej pracy magisterskiej dotyczącej porównania wybranych testów normalności metodą symulacji Monte Carlo.
...
Obliczenia wykonano w programie R w wersji 4.2.3.

## Temat pracy

Praca dotyczy wybranych testów normalności oraz porównania ich działania metodą symulacji Monte Carlo.
